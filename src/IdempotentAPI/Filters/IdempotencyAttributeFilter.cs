...
namespace IdempotentAPI.Filters
{
	public class IdempotencyAttributeFilter : IAsyncActionFilter, IAsyncResultFilter
	{
		...
		public IdempotencyAttributeFilter(
			...
			bool cacheOnlySuccessResponses): this(distributedCache, loggerFactory, enabled, TimeSpan.FromHours(expireHours),headerKeyName, distributedCacheKeysPrefix, distributedLockTimeout, cacheOnlySuccessResponses)
		{
		}
